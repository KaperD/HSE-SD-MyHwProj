...
- В __stdout__ выводить комментарий о проверке работы
- Возвращать нулевой код возврата, когда проверка успешна. Иначе - ненулевой
- Дополнительные комментарии об ошибках могут быть выведены в __stderr__
...
- Сохраняет код возврата, логи ошибок из __stderr__ и комментарии о проверке из __stdout__
